...
<body>
    ...
    <div class="realtime-statistic-area">
        <div class="container" style="padding-left: 20%;padding-right: 20%">
            <div class="row">
            	<h1 style='font-family:Baskerville BOLD BT'>View Particular Faculty</h1><br>
            		<form action="ViewFacultyDetails.jsp" method="get" onsubmit="return f1()">
	            	    ...
	            	    <div class="form-group">
	            	    	<input type="submit" value="Get Details" class="btn btn-primary" style="width:49%">
