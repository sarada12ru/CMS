           	...
           	<div class="top_menu row m0">
           		<div class="container">
					<div class="float-right">
						<a class="dn_btn" href="tel:+91 0000000000">+91 0000000000</a>
						<a class="dn_btn" href="mailto:info@example.com">info@example.com</a>
					</div>
           		</div>	
           	</div>	
            <div class="main_menu">
            	<nav class="navbar navbar-expand-lg navbar-light">
					<div class="container">
						...
						<a class="navbar-brand logo_h" href="index.jsp"><img src="includes/img/logo.png" alt=""></a>
							...
							<ul class="nav navbar-nav menu_nav ml-auto">
								...
								<li class="nav-item submenu dropdown">
									...
									<ul class="dropdown-menu">
										...
										<li class="nav-item"><a class="nav-link" href="course-details.jsp">Course Details</a></li>
									</ul>
								</li> 
